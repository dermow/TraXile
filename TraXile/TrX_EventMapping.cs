    ...
    public class TrX_EventMapping
    {
        ...
        public TrX_EventMapping()
        {
            _mapping = new Dictionary<string, EVENT_TYPES>
            {
                ...
                {"Eagon Caeserius: Go on, Exile - approach the tear.", EVENT_TYPES.MEMORYTEAR_ENCOUNTER }, // Initial quest
                {"Eagon Caeserius: Over here, don't dally!", EVENT_TYPES.MEMORYTEAR_ENCOUNTER },
                {"Eagon Caeserius: Here, Exile! Another tear!", EVENT_TYPES.MEMORYTEAR_ENCOUNTER },
                {"Eagon Caeserius: Exile, we have yet to unravel this one!", EVENT_TYPES.MEMORYTEAR_ENCOUNTER },
                {"Eagon Caeserius: Look, Exile - a fresh tear!", EVENT_TYPES.MEMORYTEAR_ENCOUNTER },
