...
<!-- CORE FEATURES -->
### Features
#### Activity Tracking (live and historically)
TraXile records your activities ingame like maps, heists, labs and so on based on your Client.txt. That means it works for live tracking (have Traxile open while playing)
ans also for all activities that are logged to your Client.txt. TraXile records the time you need for that activities - automatically pauses  when you leave them and collects
