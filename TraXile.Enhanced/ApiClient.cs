...
namespace ApiSdk
{
    ...
    public class ApiClient : BaseRequestBuilder
    {
        ...
        public TraXile.Api.ActivityRequestBuilder Activity
        {
            get => new TraXile.Api.ActivityRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        ...
        public ApiClient(IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}", new Dictionary<string, object>())
        {
            ...
            {
                RequestAdapter.BaseUrl = "https://api.test.test123/api/v1";
            }
